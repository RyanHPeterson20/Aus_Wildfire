...
refitSE.count <- sort(SErefit3.unique, decreasing = TRUE)
...
dumb.expansion <- rep(names(temp.refitNE1), times = temp.refitNE1)
```
...
png(filename = "NE1.const.png", width = 2400, height = 1200, res = 250)
par(mar = c(5, 10, 3, 3))
barplot(height = rateNE1.const, xlim = c(0,1),
        horiz=T, las = 1, col = col.NE1)
title("NE Aus Group 1", adj = 0)
dev.off()

png(filename = "NE2.const.png", width = 2400, height = 1200, res = 250)
par(mar = c(5, 10, 3, 3))
barplot(height = rateNE2.const, xlim = c(0,1),
        horiz=T, las = 1, col = col.NE2)
title("NE Aus Group 2", adj = 0)
dev.off()

png(filename = "NE3.const.png", width = 2400, height = 1200, res = 250)
par(mar = c(5, 10, 3, 3))
barplot(height = rateNE3.const, xlim = c(0,1),
        horiz=T, las = 1, col = col.NE3)
title("NE Aus Group 3", adj = 0)
dev.off()

png(filename = "SE1.const.png", width = 2400, height = 1200, res = 250)
par(mar = c(5, 10, 3, 3))
barplot(height = rateSE1.const, xlim = c(0,1),
        horiz=T, las = 1, col = col.SE1)
title("SE Aus Group 1", adj = 0)
dev.off()

png(filename = "SE2.const.png", width = 2400, height = 1200, res = 250)
par(mar = c(5, 10, 3, 3))
barplot(height = rateSE2.const, xlim = c(0,1),
        horiz=T, las = 1, col = col.SE2)
title("SE Aus Group 2", adj = 0)
dev.off()

png(filename = "SE3.const.png", width = 2400, height = 1200, res = 250)
par(mar = c(5, 10, 3, 3))
barplot(height = rateSE3.const, xlim = c(0,1),
        horiz=T, las = 1, col = col.SE3)
...
plot(NE1x_vals, NE1y_vals, 
     pch = 19, col = "steelblue4", 
     xaxt = "n", xlab = "", ylab = "Count")
# Add x-axis labels
axis(1, at = seq_along(temp.refitNE1), labels = names(temp.refitNE1), las = 2)
title("NE Group 1: Varying Term Count")


stripchart(dumb.expansion, method = "stack",  at = 0, offset = .5,
           pch = 19, col = "steelblue", vertical = FALSE,
...
export_summs(NE1, NE1.wo2019, scale = FALSE, 
             ...
             to.file = "pdf", file.name = "NE1models.pdf", longtable = TRUE)
...
export_summs(NE2, NE2.wo2019, scale = FALSE, 
             ...
             to.file = "pdf", file.name = "NE2models.pdf", longtable = TRUE)
...
export_summs(NE3, NE3.wo2019, scale = FALSE, 
             ...
             to.file = "pdf", file.name = "NE3models.pdf", longtable = TRUE)
...
export_summs(SE1, SE1.wo2019, scale = FALSE, 
             ...
             to.file = "pdf", file.name = "SE1models.pdf", longtable = TRUE)
...
export_summs(SE2, SE2.wo2019, scale = FALSE, 
             ...
             to.file = "pdf", file.name = "SE2models.pdf", longtable = TRUE)
...
export_summs(SE3, SE3.wo2019, scale = FALSE, 
             ...
             to.file = "pdf", file.name = "SE3models.pdf", longtable = TRUE)
...
axis(2)                      
box()
title("Constant Model : RMSE", adj = 0)
dev.off()
```
