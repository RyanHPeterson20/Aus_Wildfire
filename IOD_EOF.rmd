...
per <- pca$sdev[1:kmod]^2 / sum(pca$sdev^2)

plot(per[1:2] * 100, type = "b", pch = 19,
     xlab = "EOF Mode", ylab = "Variance Explained (%)",
     main = "")
...
matplot(S_ind, type = "l", lty = 1, lwd = 2,
        xlab = "Time", ylab = "Index", main = "S-Index")
abline(h = 0, lty = 2)

matplot(M_ind, type = "l", lty = 1, lwd = 2,
        xlab = "Time", ylab = "Index", main = "M-Index")
abline(h = 0, lty = 2)
