...
test_lambda <- SEcv_new2$Group_3$lamlist[15]
...
SEfit_strong <- list(SEfit1_min, SEfit2_min, SEfit3_min, SEfit4_min)

test_out <- full_prediction(SEfit_strong, SEAus_mat, SE_laglist_std, SE_laglist_q75, NEAus = FALSE)
