...
pc1.son <- piod.son$PC1
pc2.son <- piod.son$PC2
...
pc1.jja <- piod.jja$PC1
pc2.jja <- piod.jja$PC2
...
pc1.djf <- piod.djf$PC1
pc2.djf <- piod.djf$PC2

s.index.djf  <- piod.djf$s.index
etio.djf <- dmi.djf$etio.anomaly

m.index.djf  <- piod.djf$m.index
wtio.djf <- dmi.djf$wtio.anomaly

#mam
dmi.mam <- bounded_pred2_df[mam.ind, ]
piod.mam <- pIOD.df[mam.ind,]

pc1.mam <- piod.mam$PC1
pc2.mam <- piod.mam$PC2

s.index.mam  <- piod.mam$s.index
etio.mam <- dmi.mam$etio.anomaly

m.index.mam  <- piod.mam$m.index
wtio.mam <- dmi.mam$wtio.anomaly



#fig setup
years.pIOD <- 2000:2019
years.pIOD_alt <- 2000:2020
...
djf.div <- which(diff(piod.djf$year) !=0 ) + 0.5
djf.div.full <-  c(0.5, djf.div, n.djf+0.5)

#mam setup
n.mam <- length(mam.ind)
mam.div <- which(diff(piod.mam$year) !=0 ) + 0.5
mam.div.full <-  c(0.5, mam.div, n.mam+0.5)

year.loc <- (head(son.div.full, -1) + tail(son.div.full, -1))/2
year.loc.jja <- (head(jja.div.full, -1) + tail(jja.div.full, -1))/2
year.loc.djf <- (head(djf.div.full, -1) + tail(djf.div.full, -1))/2
year.loc.mam <- (head(mam.div.full, -1) + tail(mam.div.full, -1))/2
```
...
#son
pc1.range <- range(scale(wtio.son), scale(pc1.son))

png(filename = "son_PC1wtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc1.son), scale(pc1.son), type = "l",  col = "forestgreen", ylim=pc1.range,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc, labels = years.pIOD, tick = FALSE, cex.axis = 0.67)
axis(2)                      
box()
lines(1:length(wtio.son), scale(wtio.son), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=son.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("SON Weekly - PC1 & WTIO", adj = 0)
legend("topright",
       legend = c("PC1", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
mod.range <- range(scale(wtio.son), scale(m.index.son))

png(filename = "son_modwtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(m.index.son), scale(m.index.son), type = "l",  col = "forestgreen", ylim=mod.range,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc, labels = years.pIOD, tick = FALSE, cex.axis = 0.66)
axis(2)                      
...
abline(h = 0, lty  =2)
abline(v=son.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("SON Weekly - M-Index & WTIO", adj = 0)
legend("topright",
       legend = c("M-Index", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
#jja
pc1.range.jja <- range(scale(wtio.jja), scale(pc1.jja))

png(filename = "jja_PC1wtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc1.jja), scale(pc1.jja), type = "l",  col = "forestgreen", ylim=pc1.range.jja,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.jja, labels = years.pIOD, tick = FALSE, cex.axis = 0.67)
axis(2)                      
box()
lines(1:length(wtio.jja), scale(wtio.jja), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=jja.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("JJA Weekly - PC1 & WTIO", adj = 0)
legend("topright",
       legend = c("PC1", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
mod.range.jja <- range(scale(wtio.jja), scale(m.index.jja))

png(filename = "jja_modwtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(m.index.jja), scale(m.index.jja), type = "l",  col = "forestgreen", ylim=mod.range.jja,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.jja, labels = years.pIOD, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(wtio.jja), scale(wtio.jja), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=jja.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("JJA Weekly - M-Index & WTIO", adj = 0)
legend("topright",
       legend = c("M-Index", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
dev.off()
#djf
pc1.range.djf <- range(scale(wtio.djf), scale(pc1.djf))

png(filename = "djf_PC1wtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc1.djf), scale(pc1.djf), type = "l",  col = "forestgreen", ylim=pc1.range.djf,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.djf, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.67)
axis(2)                      
box()
lines(1:length(wtio.djf), scale(wtio.djf), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=djf.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("DJF Weekly - PC1 & WTIO", adj = 0)
legend("topright",
       legend = c("PC1", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
mod.range.djf <- range(scale(wtio.djf), scale(m.index.djf))

png(filename = "djf_modwtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(m.index.djf), scale(m.index.djf), type = "l",  col = "forestgreen", ylim=mod.range.djf,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.djf, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(wtio.djf), scale(wtio.djf), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=djf.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("DJF Weekly - M-Index & WTIO", adj = 0)
legend("topright",
       legend = c("M-Index", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
#mam
pc1.range.mam <- range(scale(wtio.mam), scale(pc1.mam))

png(filename = "mam_PC1wtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc1.mam), scale(pc1.mam), type = "l",  col = "forestgreen", ylim=pc1.range.mam,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.mam, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.67)
axis(2)                      
box()
lines(1:length(wtio.mam), scale(wtio.mam), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=mam.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("MAM Weekly - PC1 & WTIO", adj = 0)
legend("topright",
       legend = c("PC1", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
mod.range.mam <- range(scale(wtio.mam), scale(m.index.mam))

png(filename = "mam_modwtio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(m.index.mam), scale(m.index.mam), type = "l",  col = "forestgreen", ylim=mod.range.mam,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.mam, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(wtio.mam), scale(wtio.mam), col = "magenta4")
abline(h = 0, lty  =2)
abline(v=mam.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("MAM Weekly - M-Index & WTIO", adj = 0)
legend("topright",
       legend = c("M-Index", "WTIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
setwd("~/CO_AUS/Aus_CO-main/Interactions_New/Figures/New")
#son
pc2.range <- range(scale(etio.son), scale(pc2.son))

png(filename = "son_PC2etio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc2.son), scale(pc2.son), type = "l",  col = "firebrick", ylim=pc2.range,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc, labels = years.pIOD, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(etio.son), scale(-etio.son), col = "royalblue4")
abline(h = 0, lty  =2)
abline(v=son.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("SON Weekly - PC2 & ETIO", adj = 0)
legend("topright",
       legend = c("PC2", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
strong.range <- range(scale(etio.son), scale(s.index.son))

png(filename = "son_stretio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(s.index.son), scale(s.index.son), type = "l",  col = "firebrick", ylim=strong.range,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc, labels = years.pIOD, tick = FALSE, cex.axis = 0.66)
axis(2)                      
...
abline(h = 0, lty  =2)
abline(v=son.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("SON Weekly - S-Index & ETIO", adj = 0)
legend("topright",
       legend = c("S-Index", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
#jja
pc2.range.jja <- range(scale(-etio.jja), scale(pc2.jja))

png(filename = "jja_PC2etio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc2.jja), scale(pc2.jja), type = "l",  col = "firebrick", ylim=pc2.range.jja,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.jja, labels = years.pIOD, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(etio.jja), scale(-etio.jja), col = "royalblue4")
abline(h = 0, lty  =2)
abline(v=jja.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("JJA Weekly - PC2 & ETIO", adj = 0)
legend("topright",
       legend = c("PC2", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
strong.range.jja <- range(scale(-etio.jja), scale(s.index.jja))

png(filename = "jja_stretio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(s.index.jja), scale(s.index.jja), type = "l",  col = "firebrick", ylim=strong.range.jja,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.jja, labels = years.pIOD, tick = FALSE, cex.axis = 0.66)
axis(2)                      
...
abline(h = 0, lty  =2)
abline(v=jja.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("JJA Weekly - S-Index & ETIO", adj = 0)
legend("topright",
       legend = c("S-Index", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
#djf
pc2.range.djf <- range(scale(-etio.djf), scale(pc2.djf))

png(filename = "djf_PC2etio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc2.djf), scale(pc2.djf), type = "l",  col = "firebrick", ylim=pc2.range.djf,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.djf, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(etio.djf), scale(-etio.djf), col = "royalblue4")
abline(h = 0, lty  =2)
abline(v=djf.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("DJF Weekly - PC2 & ETIO", adj = 0)
legend("topright",
       legend = c("PC2", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
strong.range.djf <- range(scale(-etio.djf), scale(s.index.djf))

png(filename = "djf_stretio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(s.index.djf), scale(s.index.djf), type = "l",  col = "firebrick", ylim=strong.range.djf,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.djf, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.66)
axis(2)                      
...
abline(h = 0, lty  =2)
abline(v=djf.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("DJF Weekly - S-Index & ETIO", adj = 0)
legend("topright",
       legend = c("S-Index", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
#mam
pc2.range.mam <- range(scale(-etio.mam), scale(pc2.mam))

png(filename = "mam_PC2etio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(pc2.mam), scale(pc2.mam), type = "l",  col = "firebrick", ylim=pc2.range.mam,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.mam, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.66)
axis(2)                      
box()
lines(1:length(etio.mam), scale(-etio.mam), col = "royalblue4")
abline(h = 0, lty  =2)
abline(v=mam.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("MAM Weekly - PC2 & ETIO", adj = 0)
legend("topright",
       legend = c("PC2", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
strong.range.mam <- range(scale(-etio.mam), scale(s.index.mam))

png(filename = "mam_stretio.png", width = 2800, height = 1300, res = 250)
par(mar = c(5, 5, 3, 7.3))
plot(1:length(s.index.mam), scale(s.index.mam), type = "l",  col = "firebrick", ylim=strong.range.mam,
     ylab = "Index", xlab = "Year",
           axes = FALSE)
axis(1, at = year.loc.mam, labels = years.pIOD_alt, tick = FALSE, cex.axis = 0.66)
axis(2)                      
...
abline(h = 0, lty  =2)
abline(v=mam.div.full, lty = 3, lwd = 0.75, col = "gray35")
title("MAM Weekly - S-Index & ETIO", adj = 0)
legend("topright",
       legend = c("S-Index", "-ETIO"),
       lty    = c(1,1),                 # line type
       lwd    = 1.33,                 # line width
...
jja.wtio.pc1 <- cor(dmi.jja$wtio.anomaly, scale(piod.jja$PC1))
jja.etio.pc2 <- cor(dmi.jja$etio.anomaly, scale(piod.jja$PC2))
...
son.wtio.pc1 <- cor(dmi.son$wtio.anomaly, scale(piod.son$PC1))
son.etio.pc2 <- cor(dmi.son$etio.anomaly, scale(piod.son$PC2))

#djf cor
wtio.djf.cor <- cor(dmi.djf$wtio.anomaly, piod.djf$m.index)
etio.djf.cor <- cor(dmi.djf$etio.anomaly, piod.djf$s.index)

djf.wtio.pc1 <- cor(dmi.djf$wtio.anomaly, scale(piod.djf$PC1))
djf.etio.pc2 <- cor(dmi.djf$etio.anomaly, scale(piod.djf$PC2)) 

#mam cor
wtio.mam.cor <- cor(dmi.mam$wtio.anomaly, piod.mam$m.index)
etio.mam.cor <- cor(dmi.mam$etio.anomaly, piod.mam$s.index)

mam.wtio.pc1 <- cor(dmi.mam$wtio.anomaly, scale(piod.mam$PC1))
mam.etio.pc2 <- cor(dmi.mam$etio.anomaly, scale(piod.mam$PC2))
...
#jja wtio and pc1
png(filename = "jjawtio_pc1.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(scale(dmi.jja$wtio.anomaly), scale(piod.jja$PC1), pch = 16, cex = 0.89,
     xlab = "WTIO", ylab = "PC1")
text(-0.65, 3, paste0("Cor = ", round(jja.wtio.pc1, 3)), adj = 0 )
title("JJA: WTIO and PC1", adj = 0)
dev.off()

#etio and pc2
png(filename = "jjaetio_pc2.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.jja$etio.anomaly, scale(piod.jja$PC2), pch = 16, cex = 0.89,
     xlab = "ETIO", ylab = "PC2")
text(-1.15, -2, paste0("Cor = ", round(jja.etio.pc2, 3)), adj = 0 )
title("JJA: ETIO and PC2", adj = 0)
dev.off()

#son wtio and pc1
png(filename = "sonwtio_pc1.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.son$wtio.anomaly, scale(piod.son$PC1), pch = 16, cex = 0.89,
     xlab = "WTIO", ylab = "PC1")
text(-0.45, 2.5, paste0("Cor = ", round(son.wtio.pc1, 3)), adj = 0 )
title("SON: WTIO and PC1", adj = 0)
dev.off()

#etio and pc2
png(filename = "sonetio_pc2.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.son$etio.anomaly, scale(piod.son$PC2), pch = 16, cex = 0.89,
     xlab = "ETIO", ylab = "PC2")
text(-1.65, -1.95, paste0("Cor = ", round(son.etio.pc2, 3)), adj = 0 )
title("SON: ETIO and PC2", adj = 0)
dev.off()

#djf wtio and pc1
png(filename = "djfnwtio_pc1.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.djf$wtio.anomaly, scale(piod.djf$PC1), pch = 16, cex = 0.89,
     xlab = "WTIO", ylab = "PC1")
text(-0.70, 1.9, paste0("Cor = ", round(djf.wtio.pc1, 3)), adj = 0 )
title("DJF: WTIO and PC1", adj = 0)
dev.off()


#etio and pc2
png(filename = "djfetio_pc2.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.djf$etio.anomaly, scale(piod.djf$PC2), pch = 16, cex = 0.89,
     xlab = "ETIO", ylab = "PC2")
text(-0.7, -2, paste0("Cor = ", round(djf.etio.pc2, 3)), adj = 0 )
title("DJF: ETIO and PC2", adj = 0)
dev.off()

#mam wtio and pc1
png(filename = "mamnwtio_pc1.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.mam$wtio.anomaly, scale(piod.mam$PC1), pch = 16, cex = 0.89,
     xlab = "WTIO", ylab = "PC1")
text(-0.5, 2.85, paste0("Cor = ", round(mam.wtio.pc1, 3)), adj = 0 )
title("MAM: WTIO and PC1", adj = 0)
dev.off()

#etio and pc2
png(filename = "mametio_pc2.png", width = 2000, height = 1200, res = 250)
par(mar = c(5, 5, 3, 5))
plot(dmi.mam$etio.anomaly, scale(piod.mam$PC2), pch = 16, cex = 0.89,
     xlab = "ETIO", ylab = "PC2")
text(-1, -2.9, paste0("Cor = ", round(mam.etio.pc2, 3)), adj = 0 )
