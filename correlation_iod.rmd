...
cor(bounded_pred2_df$etio.anomaly, pIOD.df$PC1)
cor(bounded_pred2_df$wtio.anomaly, pIOD.df$PC2)
...
#son correlation
wtio.pc1.son <- cor(dmi.son$wtio.anomaly, piod.son$PC1)
...
par(mar = c(5, 5, 3, 5))
plot(dmi.son$wtio.anomaly, scale(piod.son$m.index), pch = 19, cex = 0.86,
...
par(mar = c(5, 5, 3, 5))
plot(dmi.son$etio.anomaly, scale(piod.son$s.index), pch = 19, cex = 0.86,
