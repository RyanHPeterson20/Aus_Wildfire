...
ccf(as.numeric(etio_ts), as.numeric(NEaus_ts), type = "correlation", 
    lag = 52, main = "ETIO & NE Aus")

ccf(as.numeric(etio_ts), as.numeric(SEaus_ts), type = "correlation", 
    lag = 52, main = "ETIO & SE Aus")
