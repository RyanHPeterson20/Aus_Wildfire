...
png("NEcluster.png", width = 2250, height = 1250, res = 200)
...
stats:::plot.hclust(NEconst_clust, hang = -1, labels = FALSE, bty = "n", sub = "", ylab = "",
                    xlab = "", main = "NE Aus : Response Clustering", axes = FALSE, cex.main = 2.25)
#axis(2)
...
png("SEcluster.png", width = 2250, height = 1250, res = 200)
#par(mar = c(5, 4, 4, 5) + 0.2, xpd = TRUE)  # Increase the right margin (fourth value) to make space for the legend
par(mgp = c(3, -0.75, 0))
stats:::plot.hclust(SEconst_clust, hang = -1, labels = FALSE, bty = "n", sub = "", ylab = "",
                    xlab = "", main = "SE Aus : Response Clustering", axes = FALSE, cex.main = 2.25)
#axis(2)
axis(1, at = 1:32, labels = c(paste0("Week ", season_weeks[1:32])), 
     las = 3, gap.axis = 0, tck = 0.5, lty = 0, cex.axis = 1.6)
