...
NEresp_grouping <- function(NEAus_mat, j = (1:19)){
  ...
  NEAus1_resp <- scale(as.vector(NEAus_mat[[1]]), center = TRUE, scale = FALSE)
  NEAus2_resp <- scale(as.vector(NEAus_mat[[2]]), center = TRUE, scale = FALSE)
  NEAus3_resp <- scale(as.vector(NEAus_mat[[3]]), center = TRUE, scale = FALSE) 
  NEAus4_resp <- scale(as.vector(NEAus_mat[[4]]), center = TRUE, scale = FALSE)
  NEAus5_resp <- scale(as.vector(NEAus_mat[[5]]), center = TRUE, scale = FALSE)
  NEAus6_resp <- scale(as.vector(NEAus_mat[[6]]), center = TRUE, scale = FALSE)
...
```{r residual_pred}
#NE Aus: residual spikes in group 5
#SE Aus: residual spikes in group 4
