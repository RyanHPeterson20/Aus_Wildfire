...
#2020
nc.GODAS.2020 <- nc_open("~/CO_AUS/Aus_CO-main/pIOD/Data/pottmp.2020.nc")

#2021
nc.GODAS.2021 <- nc_open("~/CO_AUS/Aus_CO-main/pIOD/Data/pottmp.2021.nc")
```
...
#1990-present
nc.OISST.weekly1 <- nc_open("~/CO_AUS/Aus_CO-main/pIOD/Data/sst.wkmean.1990-present.nc")

#1981-1989
nc.OISST.weekly2 <- nc_open("~/CO_AUS/Aus_CO-main/pIOD/Data/sst.wkmean.1981-1989.nc")
...
dim(sst.oisst.weeklynew)
```


```{r save_weekly}
setwd("~/CO_AUS/Aus_CO-main/pIOD")
save(sst.oisst.weeklynew, times.oisst, file = "sstOISSTweekly.rda")
```
...
# OLD SST Anom Work
Everything below here will be moved elsewhere... eventually
