...
for (i in 1:length(godas_list)) {
  ...
  sst.GODAS.new2 <- temp.sst[lon.range[1]:lon.range[2], lat.range[1]:lat.range[2], ]
...
save(sst.GODAS.new, sst.GODAS.new2, file = "sstGODAS.rda")
```
...
```{r}
#TODO: work in-progress code chunk
