...
#test plots
#plot(1:7, NEsil_matrix[,1], type = "b")
...
plot(1:7, NEsil_matrix[,4], type = "b", pch = 18, ylim = sil_range, axes = FALSE,
     ylab = "Coefficient", xlab = "Start Week", main = "NE Silhouette Coefficients")
box()
axis(2)
...
plot(1:7, SEsil_matrix[,4], type = "b", pch = 18, ylim = sil_range, axes = FALSE,
     ylab = "Coefficient", xlab = "Start Week", main = "SE Silhouette Coefficients")
box()
axis(2)
axis(1, at = 1:7, labels = c(season_weeks[1:7]))
...
plot(1:6, diff(SEsil_matrix[,4]), type = "b", pch = 18, ylim = c(-0.01, 0.035),
     ylab = expression(paste(Delta, " Coefficient")), xlab = "")
