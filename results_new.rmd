...
NEd2 <- dist(t(NEbase_matrix1), method = "euclidean")
SEd2 <- dist(t(SEbase_matrix1), method = "euclidean")

#clustering
NEhc <- constr.hclust(NEd2, method = "ward.D2", chron = TRUE)
SEhc <- constr.hclust(SEd2, method = "ward.D2", chron = TRUE)

#groups
NEcut3 <- cutree(NEhc, k = 3)
SEcut3 <- cutree(SEhc, k = 3)
...
plot(NEmds_base$conf) #, label.conf = list(pos = 5))
```
