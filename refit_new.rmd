...
which.min(NErefit2[[5]][1:29 , 5]) # Ridge BIC
which.min(NErefit2[[5]][1:29 , 6]) # Lasso BIC
...
which.min(NErefit3[[5]][1:29 , 5]) #ridge BIC
which.min(NErefit3[[5]][1:29 , 6]) #lasso BIC
...
```{r plot_BIC}
#plotting BIC with respect to various values to get the appropriate range
plot(NErefit1[[5]][1:10,1], NErefit1[[5]][1:10,5], type = "b", pch = 16)
lines(NErefit1[[5]][1:10,1],NErefit1[[5]][1:10,6], type = "b", pch = 16, col = "red", lty = 2 )

NEaus_df <- NULL
for (i in 1:10) {
  
  NEaus_df <- c(NEaus_df ,length( NErefit1[[4]][[i]]))
}

plot(NErefit1[[5]][1:10,1], NEaus_df)
...
which.min(SErefit1[[5]][1:30,5]) #ridge BIC
...
SErefit2[[5]]
which.min(SErefit2[[5]][1:30, 5]) #ridge BIC
which.min(SErefit2[[5]][1:30, 6]) #Lasso BIC
...
which.min(SErefit3[[5]][1:30,5]) # ridge BIC
which.min(SErefit3[[5]][1:30,6]) # lasso BIC
...
which.min(NErefit1[[5]][1:29 , 2]) #AIC (max lambda 1se)
which.min(NErefit1[[5]][1:29 , 5]) #Ridge BIC
which.min(NErefit1[[5]][1:29 , 6]) #Lasso BIC
which.min(NErefit1[[5]][1:25 , 10]) #GIC 
...
which.min(SErefit1[[5]][1:30,2]) #AIC
which.min(SErefit1[[5]][1:30, 5]) #ridge BIC
which.min(SErefit1[[5]][1:30, 6]) #lasso BIC
which.min(SErefit1[[5]][1:30,10]) #GIC
...
## base
links[[5]] <- list(
  y_val = NE32_ninocoef[3],
  from_x = grconvertX(NE32_ninolag[3], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_ninocoef[3], from = "user", to = "ndc")
)
...
## base
links[[21]] <- list(
  y_val = NE32_dmicoef[5],
  from_x = grconvertX(NE32_dmilag[5], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_dmicoef[5], from = "user", to = "ndc")
)
#dmi_lag31:tsa_lag52
##dmi_lag31
## base
links[[22]] <- list(
  y_val = NE32_dmicoef[6],
  from_x = grconvertX(NE32_dmilag[6], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_dmicoef[6], from = "user", to = "ndc")
)
...
## base
links[[23]] <- list(
  y_val = NE32_tsacoef[9],
  from_x = grconvertX(NE32_tsalag[9], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_tsacoef[9], from = "user", to = "ndc")
)
#dmi_lag17:tsa_lag48
## tsa_lag48
## base
links[[24]] <- list(
  y_val = NE32_tsacoef[10],
  from_x = grconvertX(NE32_tsalag[10], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_tsacoef[10], from = "user", to = "ndc")
)
...
## base
links[[16]] <- list(
  y_val = NE32_aaocoef[3],
  from_x = grconvertX(NE32_aaolag[3], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_aaocoef[3], from = "user", to = "ndc")
)
...
int_5 <- grconvertY(links[[5]]$from_y, from = "ndc", to = "user") # nino_lag41
int_pt1 <- (int_4 + int_5)/2
segments(NEridge3_base[35], int_4, NEridge3_base[35], int_pt1, col = "chartreuse2", lty = 3, lwd = 1.5)
segments(NEridge3_base[35], int_5, NEridge3_base[35], int_pt1, col = "chartreuse2", lty = 3, lwd = 1.5)
# dmi_lag18:tsa_lag52
...
segments(NEridge3_base[39], int_6, NEridge3_base[39], int_pt2, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[39], int_14, NEridge3_base[39], int_pt2, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag19:tsa_lag52
int_7 <- grconvertY(links[[7]]$from_y, from = "ndc", to = "user") # dmi_lag19
int_14 <- grconvertY(links[[14]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt3 <- (int_7 + int_14)/2
segments(NEridge3_base[40], int_7, NEridge3_base[40], int_pt3, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[40], int_14, NEridge3_base[40], int_pt3, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
#dmi_lag19:tsa_lag52 
...
#updated NEridge3_base
int_15 <- grconvertY(links[[15]]$from_y, from = "ndc", to = "user") # I(nino_lag21^2)
int_16 <- grconvertY(links[[16]]$from_y, from = "ndc", to = "user") # I(aao_lag44^2)
int_17 <- grconvertY(links[[17]]$from_y, from = "ndc", to = "user") # I(NEolr_lag19^2)
# dmi_lag17:tsa_lag47
int_18 <- grconvertY(links[[18]]$from_y, from = "ndc", to = "user") # dmi_lag17
int_23 <- grconvertY(links[[23]]$from_y, from = "ndc", to = "user") # tsa_lag47 (base)
int_pt8 <- (int_18 + int_23)/2
segments(NEridge3_base[36], int_18, NEridge3_base[36], int_pt8, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[36], int_23, NEridge3_base[36], int_pt8, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag17:tsa_lag48
int_19 <- grconvertY(links[[19]]$from_y, from = "ndc", to = "user") # dmi_lag17
int_24 <- grconvertY(links[[24]]$from_y, from = "ndc", to = "user") # tsa_lag48 (base)
int_pt9 <- (int_19 + int_24)/2
segments(NEridge3_base[37], int_19, NEridge3_base[37], int_pt9, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[37], int_24, NEridge3_base[37], int_pt9, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag17:tsa_lag52
int_20 <- grconvertY(links[[20]]$from_y, from = "ndc", to = "user") # dmi_lag17
int_14 <- grconvertY(links[[14]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt10 <- (int_20 + int_14)/2
segments(NEridge3_base[38], int_20, NEridge3_base[38], int_pt10, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[38], int_14, NEridge3_base[38], int_pt10, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag26:tsa_lag52
int_21 <- grconvertY(links[[21]]$from_y, from = "ndc", to = "user") # dmi_lag26
int_14 <- grconvertY(links[[14]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt11 <- (int_21 + int_14)/2
segments(NEridge3_base[41], int_21, NEridge3_base[41], int_pt11, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[41], int_14, NEridge3_base[41], int_pt11, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag31:tsa_lag52
int_22 <- grconvertY(links[[22]]$from_y, from = "ndc", to = "user") # dmi_lag31
int_14 <- grconvertY(links[[14]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt12 <- (int_22 + int_14)/2
segments(NEridge3_base[42], int_22, NEridge3_base[42], int_pt12, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[42], int_14, NEridge3_base[42], int_pt12, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
...
points(NEridge3_main1[24], int_2, pch = 22, col = "black",
       bg =  alpha("plum2",.65) , cex = 1.5)
points(NEridge3_base[34], int_3, pch = 24, col = "black",
       bg =  alpha("paleturquoise3",.65) , cex = 1.33)
points(NEridge3_base[35], int_pt1, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[39], int_pt2, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[40], int_pt3, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
...
points(NEridge3_base[31], int_15,  pch = 24, col = "grey4",
        bg =  alpha("chartreuse2",.95), cex = 1.5,) 
points(NEridge3_base[32], int_16, pch = 24, col = "black",
       bg =  alpha("coral2",.65) , cex = 1.5)
points(NEridge3_base[33], int_17, pch = 24, col = "black",
       bg =  alpha("paleturquoise3",.65) , cex = 1.33)

#link to x 
links[[1]]$to_x <- grconvertX(NEridge3_main[24], from = "user", to = "ndc")
links[[2]]$to_x <- grconvertX(NEridge3_main1[24], from = "user", to = "ndc")
links[[3]]$to_x <- grconvertX(NEridge3_base[34], from = "user", to = "ndc")
links[[4]]$to_x <- grconvertX(NEridge3_base[35], from = "user", to = "ndc")
links[[5]]$to_x <- grconvertX(NEridge3_base[35], from = "user", to = "ndc")
links[[6]]$to_x <- grconvertX(NEridge3_base[39], from = "user", to = "ndc")
links[[7]]$to_x <- grconvertX(NEridge3_base[40], from = "user", to = "ndc")
...
links[[14]]$to_x <- grconvertX(NEridge3_base[39], from = "user", to = "ndc")

links[[15]]$to_x <- grconvertX(NEridge3_base[31], from = "user", to = "ndc")
links[[16]]$to_x <- grconvertX(NEridge3_base[32], from = "user", to = "ndc")
links[[17]]$to_x <- grconvertX(NEridge3_base[33], from = "user", to = "ndc")
links[[18]]$to_x <- grconvertX(NEridge3_base[36], from = "user", to = "ndc")
links[[19]]$to_x <- grconvertX(NEridge3_base[37], from = "user", to = "ndc")
links[[20]]$to_x <- grconvertX(NEridge3_base[38], from = "user", to = "ndc")
links[[21]]$to_x <- grconvertX(NEridge3_base[41], from = "user", to = "ndc")
links[[22]]$to_x <- grconvertX(NEridge3_base[42], from = "user", to = "ndc")
links[[23]]$to_x <- grconvertX(NEridge3_base[36], from = "user", to = "ndc")
links[[24]]$to_x <- grconvertX(NEridge3_base[37], from = "user", to = "ndc")
...
colors <- c("magenta4", "plum2", "paleturquoise3", rep("chartreuse3",2 ),
            ...
            "darkorange3", "darkgoldenrod3","darkgoldenrod3",
            "chartreuse3", "coral2", "paleturquoise3", 
            rep("plum2", 5), rep("darkgoldenrod3", 2))
linetypes <- c(rep(2,3), rep(3, 11), rep(2,3), rep(3,7) )
...
png(filename = "NE1_fits.png", width = 3000, height = 3000, res = 300)
layout(matrix(c(1, 6,
                2, 6,
                3, 6,
                4, 6,
...
png(filename = "NE2_fits.png", width = 3000, height = 3000, res = 300)
...
#squared
int_1 <- grconvertY(links[[1]]$from_y, from = "ndc", to = "user") # I(nino_lag15^2)
int_2 <- grconvertY(links[[2]]$from_y, from = "ndc", to = "user") # I(dmi_lag3^2)
int_3 <- grconvertY(links[[3]]$from_y, from = "ndc", to = "user") # I(dmi_lag7^2)
int_4 <- grconvertY(links[[4]]$from_y, from = "ndc", to = "user") # I(dmi_lag41^2)
int_5 <- grconvertY(links[[5]]$from_y, from = "ndc", to = "user") # I(tsa_lag47^2) 
int_6 <- grconvertY(links[[6]]$from_y, from = "ndc", to = "user") 
int_7 <- grconvertY(links[[7]]$from_y, from = "ndc", to = "user") # I(NEolr_lag30^2) 
int_8 <- grconvertY(links[[8]]$from_y, from = "ndc", to = "user") # I(NEolr_lag32^2) 
int_9 <- grconvertY(links[[9]]$from_y, from = "ndc", to = "user") # I(NEolr_lag52^2) 
#interactions
# nino_lag30:aao_lag40
int_10 <- grconvertY(links[[10]]$from_y, from = "ndc", to = "user") # nino_lag30
int_15 <- grconvertY(links[[15]]$from_y, from = "ndc", to = "user") # aao_lag40
int_pt1 <- (int_10 + int_15)/2
segments(NEridge2_main[32], int_10, NEridge2_main[32], int_pt1, col = "green4", lty = 3, lwd = 1.5)
segments(NEridge2_main[32], int_15, NEridge2_main[32], int_pt1, col = "red3", lty = 3, lwd = 1.5)
# dmi_lag12:NEolr_lag1
int_11 <- grconvertY(links[[11]]$from_y, from = "ndc", to = "user") # dmi_lag12
int_16 <- grconvertY(links[[16]]$from_y, from = "ndc", to = "user") # NEolr_lag1
int_pt2 <- (int_11 + int_16)/2
segments(NEridge2_main[33], int_11, NEridge2_main[33], int_pt2, col = "magenta4", lty = 3, lwd = 1.5)
segments(NEridge2_main[33], int_16, NEridge2_main[33], int_pt2, col = "turquoise4", lty = 3, lwd = 1.5)
# dmi_lag41:NEolr_lag1
int_12 <- grconvertY(links[[12]]$from_y, from = "ndc", to = "user") # dmi_lag41
int_17 <- grconvertY(links[[17]]$from_y, from = "ndc", to = "user") # NEolr_lag1
int_pt3 <- (int_12 + int_17)/2
segments(NEridge2_main[34], int_12, NEridge2_main[34], int_pt3, col = "magenta4", lty = 3, lwd = 1.5)
segments(NEridge2_main[34], int_17, NEridge2_main[34], int_pt3, col = "turquoise4", lty = 3, lwd = 1.5)
# dmi_lag50:NEolr_lag2
int_13 <- grconvertY(links[[13]]$from_y, from = "ndc", to = "user") # dmi_lag50
int_18 <- grconvertY(links[[18]]$from_y, from = "ndc", to = "user") # NEolr_lag2
int_pt4 <- (int_13 + int_18)/2
segments(NEridge2_main[35], int_13, NEridge2_main[35], int_pt4, col = "magenta4", lty = 3, lwd = 1.5)
segments(NEridge2_main[35], int_18, NEridge2_main[35], int_pt4, col = "turquoise4", lty = 3, lwd = 1.5)
# tsa_lag44:NEolr_lag52
int_14 <- grconvertY(links[[14]]$from_y, from = "ndc", to = "user") # tsa_lag44
int_19 <- grconvertY(links[[19]]$from_y, from = "ndc", to = "user") # NEolr_lag52
int_pt5 <- (int_14 + int_19)/2
segments(NEridge2_main[36], int_14, NEridge2_main[36], int_pt5, col = "darkorange3", lty = 3, lwd = 1.5)
segments(NEridge2_main[36], int_19, NEridge2_main[36], int_pt5, col = "turquoise4", lty = 3, lwd = 1.5)
#segments
...
points(NEridge2_main[25], int_1,  pch = 22, col = "grey4",
        bg =  alpha("green4",.95), cex = 1.5,) 
points(NEridge2_base[7], int_2, pch = 24, col = "black",
       bg =  alpha("plum2",.65) , cex = 1.33)

points(NEridge2_main[26], int_3,  pch = 22, col = "grey4",
        bg =  alpha("magenta4",.95), cex = 1.5,)

points(NEridge2_main[27], int_4,  pch = 22, col = "grey4",
        bg =  alpha("magenta4",.95), cex = 1.5,) 

points(NEridge2_main[28], int_5,  pch = 22, col = "grey4",
        bg =  alpha("darkorange3",.95), cex = 1.5,) 
points(NEridge2_base[8], int_6, pch = 24, col = "black",
       bg =  alpha("darkgoldenrod2",.65) , cex = 1.33)

points(NEridge2_main[29], int_7,  pch = 22, col = "grey4",
        bg =  alpha("turquoise4",.95), cex = 1.5,) 
points(NEridge2_main[30], int_8,  pch = 22, col = "grey4",
        bg =  alpha("turquoise4",.95), cex = 1.5,) 
points(NEridge2_main[31], int_9,  pch = 22, col = "grey4",
        bg =  alpha("turquoise4",.95), cex = 1.5,) 


points(NEridge2_main[32], int_pt1, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge2_main[33], int_pt2, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge2_main[34], int_pt3, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge2_main[35], int_pt4, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge2_main[36], int_pt5, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 



#link to x 
links[[1]]$to_x <- grconvertX(NEridge2_main[25], from = "user", to = "ndc")
links[[2]]$to_x <- grconvertX(NEridge2_base[7], from = "user", to = "ndc")
links[[3]]$to_x <- grconvertX(NEridge2_main[26], from = "user", to = "ndc")
links[[4]]$to_x <- grconvertX(NEridge2_main[27], from = "user", to = "ndc")
links[[5]]$to_x <- grconvertX(NEridge2_main[28], from = "user", to = "ndc")
links[[6]]$to_x <- grconvertX(NEridge2_base[8], from = "user", to = "ndc")
links[[7]]$to_x <- grconvertX(NEridge2_main[29], from = "user", to = "ndc")
links[[8]]$to_x <- grconvertX(NEridge2_main[30], from = "user", to = "ndc")
links[[9]]$to_x <- grconvertX(NEridge2_main[31], from = "user", to = "ndc")
links[[10]]$to_x <- grconvertX(NEridge2_main[32], from = "user", to = "ndc")
links[[11]]$to_x <- grconvertX(NEridge2_main[33], from = "user", to = "ndc")
links[[12]]$to_x <- grconvertX(NEridge2_main[34], from = "user", to = "ndc")
links[[13]]$to_x <- grconvertX(NEridge2_main[35], from = "user", to = "ndc")
links[[14]]$to_x <- grconvertX(NEridge2_main[36], from = "user", to = "ndc")
links[[15]]$to_x <- grconvertX(NEridge2_main[32], from = "user", to = "ndc")
links[[16]]$to_x <- grconvertX(NEridge2_main[33], from = "user", to = "ndc")
links[[17]]$to_x <- grconvertX(NEridge2_main[34], from = "user", to = "ndc")
links[[18]]$to_x <- grconvertX(NEridge2_main[35], from = "user", to = "ndc")
links[[19]]$to_x <- grconvertX(NEridge2_main[36], from = "user", to = "ndc")
...
# --- Draw horizontal linking lines ---
par(xpd = NA)  # allow drawing outside plot regions
colors <- c("green4", "plum2", rep("magenta4", 2), 
            "darkorange3", "darkgoldenrod3",rep(c("turquoise4"),3),
            "green4",  rep("magenta4", 3),  "darkorange3",
            "red3", rep("turquoise4", 4))
linetypes <- c(rep(2,9), rep(3,10))
...
png(filename = "NE3_fits.png", width = 3000, height = 3000, res = 300)
...
## base
links[[10]] <- list(
  y_val = NE32_tsacoef[11],
  from_x = grconvertX(NE32_tsalag[11], from = "user", to = "ndc"),
  from_y = grconvertY(NE32_tsacoef[11], from = "user", to = "ndc")
)
#dmi_lag17:tsa_lag47   
## tsa_lag47
## base
...
#squared
int_1 <- grconvertY(links[[1]]$from_y, from = "ndc", to = "user") # I(dmi_lag8^2)
int_2 <- grconvertY(links[[2]]$from_y, from = "ndc", to = "user") # I(NEolr_lag20^2)
#interactions
# nino_lag25:nino_lag52
int_3 <- grconvertY(links[[3]]$from_y, from = "ndc", to = "user") # nino_lag25
int_4 <- grconvertY(links[[4]]$from_y, from = "ndc", to = "user") # nino_lag41
int_pt1 <- (int_3 + int_4)/2
segments(NEridge3_base[35], int_3, NEridge3_base[35], int_pt1, col = "chartreuse2", lty = 3, lwd = 1.5)
segments(NEridge3_base[35], int_4, NEridge3_base[35], int_pt1, col = "chartreuse2", lty = 3, lwd = 1.5)
# dmi_lag18:tsa_lag52
int_5 <- grconvertY(links[[5]]$from_y, from = "ndc", to = "user") # dmi_lag18
int_10 <- grconvertY(links[[10]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt2 <- (int_5 + int_10)/2
segments(NEridge3_base[39], int_5, NEridge3_base[39], int_pt2, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[39], int_10, NEridge3_base[39], int_pt2, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag19:tsa_lag52
int_6 <- grconvertY(links[[6]]$from_y, from = "ndc", to = "user") # dmi_lag19
int_10 <- grconvertY(links[[10]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt3 <- (int_6 + int_10)/2
segments(NEridge3_base[40], int_6, NEridge3_base[40], int_pt3, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[40], int_10, NEridge3_base[40], int_pt3, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
#dmi_lag19:tsa_lag52 
int_7 <- grconvertY(links[[7]]$from_y, from = "ndc", to = "user") # dmi_lag19
int_9 <- grconvertY(links[[9]]$from_y, from = "ndc", to = "user") # tsa_lag52 (main)
int_pt4 <- (int_7 + int_12)/2
segments(NEridge3_main[25], int_7, NEridge3_main[25], int_pt4, col = "magenta4", lty = 3, lwd = 1.5)
segments(NEridge3_main[25], int_9, NEridge3_main[25], int_pt4, col = "darkorange3", lty = 3, lwd = 1.5)
#dmi_lag20:tsa_lag52 
int_8 <- grconvertY(links[[8]]$from_y, from = "ndc", to = "user") # dmi_lag20
int_9 <- grconvertY(links[[9]]$from_y, from = "ndc", to = "user") # tsa_lag52 (main)
int_pt5 <- (int_8 + int_9)/2
segments(NEridge3_main[26], int_8, NEridge3_main[26], int_pt5, col = "magenta4", lty = 3, lwd = 1.5)
segments(NEridge3_main[26], int_9, NEridge3_main[26], int_pt5, col = "darkorange3", lty = 3, lwd = 1.5)


#updated NEridge3_base
int_11 <- grconvertY(links[[11]]$from_y, from = "ndc", to = "user") # I(nino_lag21^2)
int_12 <- grconvertY(links[[12]]$from_y, from = "ndc", to = "user") # I(aao_lag44^2)
int_13 <- grconvertY(links[[13]]$from_y, from = "ndc", to = "user") # I(NEolr_lag19^2)
# dmi_lag17:tsa_lag47
int_14 <- grconvertY(links[[14]]$from_y, from = "ndc", to = "user") # dmi_lag17
int_19 <- grconvertY(links[[19]]$from_y, from = "ndc", to = "user") # tsa_lag47 (base)
int_pt6 <- (int_14 + int_19)/2
segments(NEridge3_base[36], int_14, NEridge3_base[36], int_pt6, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[36], int_19, NEridge3_base[36], int_pt6, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag17:tsa_lag48
int_15 <- grconvertY(links[[15]]$from_y, from = "ndc", to = "user") # dmi_lag17
int_20 <- grconvertY(links[[20]]$from_y, from = "ndc", to = "user") # tsa_lag48 (base)
int_pt7 <- (int_15 + int_20)/2
segments(NEridge3_base[37], int_15, NEridge3_base[37], int_pt7, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[37], int_20, NEridge3_base[37], int_pt7, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag17:tsa_lag52
int_16 <- grconvertY(links[[16]]$from_y, from = "ndc", to = "user") # dmi_lag17
int_10 <- grconvertY(links[[10]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt8 <- (int_16 + int_10)/2
segments(NEridge3_base[38], int_16, NEridge3_base[38], int_pt8, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[38], int_10, NEridge3_base[38], int_pt8, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag26:tsa_lag52
int_17 <- grconvertY(links[[17]]$from_y, from = "ndc", to = "user") # dmi_lag26
int_10 <- grconvertY(links[[10]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt9 <- (int_17 + int_10)/2
segments(NEridge3_base[41], int_17, NEridge3_base[41], int_pt9, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[41], int_10, NEridge3_base[41], int_pt9, col = "darkgoldenrod3", lty = 3, lwd = 1.5)
# dmi_lag31:tsa_lag52
int_18 <- grconvertY(links[[18]]$from_y, from = "ndc", to = "user") # dmi_lag31
int_10 <- grconvertY(links[[10]]$from_y, from = "ndc", to = "user") # tsa_lag52 (base)
int_pt10 <- (int_18 + int_10)/2
segments(NEridge3_base[42], int_18, NEridge3_base[42], int_pt10, col = "plum2", lty = 3, lwd = 1.5)
segments(NEridge3_base[42], int_10, NEridge3_base[42], int_pt10, col = "darkgoldenrod3", lty = 3, lwd = 1.5)

#interaction points
points(NEridge3_main[24], int_1,  pch = 22, col = "grey4",
        bg =  alpha("magenta4",.95), cex = 1.5,) 
points(NEridge3_base[34], int_2, pch = 24, col = "black",
       bg =  alpha("paleturquoise3",.65) , cex = 1.33)
points(NEridge3_base[35], int_pt1, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[39], int_pt2, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[40], int_pt3, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_main[25], int_pt4, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_main[26], int_pt5, pch = 22, col = "black", bg = alpha("gray", 0.65), cex = 1.33)

points(NEridge3_base[31], int_11,  pch = 24, col = "grey4",
        bg =  alpha("chartreuse2",.95), cex = 1.5,) 
points(NEridge3_base[32], int_12, pch = 24, col = "black",
       bg =  alpha("coral2",.65) , cex = 1.5)
points(NEridge3_base[33], int_13, pch = 24, col = "black",
       bg =  alpha("paleturquoise3",.65) , cex = 1.33)

points(NEridge3_base[36], int_pt6, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[37], int_pt7, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[38], int_pt8, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[41], int_pt9, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 
points(NEridge3_base[42], int_pt10, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33)


#link to x 
links[[1]]$to_x <- grconvertX(NEridge3_main[24], from = "user", to = "ndc")
links[[2]]$to_x <- grconvertX(NEridge3_base[34], from = "user", to = "ndc")
links[[3]]$to_x <- grconvertX(NEridge3_base[35], from = "user", to = "ndc")
links[[4]]$to_x <- grconvertX(NEridge3_base[35], from = "user", to = "ndc")
links[[5]]$to_x <- grconvertX(NEridge3_base[39], from = "user", to = "ndc")
links[[6]]$to_x <- grconvertX(NEridge3_base[40], from = "user", to = "ndc")
links[[7]]$to_x <- grconvertX(NEridge3_main[25], from = "user", to = "ndc")
links[[8]]$to_x <- grconvertX(NEridge3_main[26], from = "user", to = "ndc")
links[[9]]$to_x <- grconvertX(NEridge3_main[25], from = "user", to = "ndc")
links[[10]]$to_x <- grconvertX(NEridge3_base[42], from = "user", to = "ndc")

links[[11]]$to_x <- grconvertX(NEridge3_base[31], from = "user", to = "ndc")
links[[12]]$to_x <- grconvertX(NEridge3_base[32], from = "user", to = "ndc")
links[[13]]$to_x <- grconvertX(NEridge3_base[33], from = "user", to = "ndc")
links[[14]]$to_x <- grconvertX(NEridge3_base[36], from = "user", to = "ndc")
links[[15]]$to_x <- grconvertX(NEridge3_base[37], from = "user", to = "ndc")
links[[16]]$to_x <- grconvertX(NEridge3_base[38], from = "user", to = "ndc")
links[[17]]$to_x <- grconvertX(NEridge3_base[41], from = "user", to = "ndc")
links[[18]]$to_x <- grconvertX(NEridge3_base[42], from = "user", to = "ndc")
links[[19]]$to_x <- grconvertX(NEridge3_base[36], from = "user", to = "ndc")
links[[20]]$to_x <- grconvertX(NEridge3_base[37], from = "user", to = "ndc")
...
# --- Draw horizontal linking lines ---
par(xpd = NA)  # allow drawing outside plot regions
colors <- c("magenta4", "paleturquoise3", rep("chartreuse3",2 ),
            "plum2", "plum2", rep("magenta4", 2), 
            "darkorange3","darkgoldenrod3",
            "chartreuse3", "coral2", "paleturquoise3", 
            rep("plum2", 5), rep("darkgoldenrod3", 2))
linetypes <- c(rep(2,2), rep(3, 8), rep(2,3), rep(3,7) )
...
png(filename = "SE1_fits.png", width = 3000, height = 3000, res = 300)
...
#squared
int_1 <- grconvertY(links[[1]]$from_y, from = "ndc", to = "user") # I(nino_lag11^2)
int_2 <- grconvertY(links[[2]]$from_y, from = "ndc", to = "user") # I(aao_lag24^2)
int_3 <- grconvertY(links[[3]]$from_y, from = "ndc", to = "user") 

#interaction points
points(SEridge1_main[5], int_1,  pch = 22, col = "grey4",
        bg =  alpha("green4",.95), cex = 1.5,) 
points(SEridge1_main[6], int_2,  pch = 22, col = "grey4",
        bg =  alpha("red3",.95), cex = 1.5,) 
points(SEridge1_base[4], int_3, pch = 24, col = "black",
       bg =  alpha("coral2",.65) , cex = 1.33)

#link to x 
links[[1]]$to_x <- grconvertX(SEridge1_main[5], from = "user", to = "ndc")
links[[2]]$to_x <- grconvertX(SEridge1_main[6], from = "user", to = "ndc")
links[[3]]$to_x <- grconvertX(SEridge1_base[4], from = "user", to = "ndc")
...
png(filename = "SE2_fits.png", width = 3000, height = 3000, res = 300)
...
# --- Range ---
SEAus2_range <- range(SEridge2_main, SEridge2_base)
SEAus2_range <- c(-1, SEAus2_range[2])
...
int_3 <- grconvertY(links[[3]]$from_y, from = "ndc", to = "user") 
int_4 <- grconvertY(links[[4]]$from_y, from = "ndc", to = "user") # I(tsa_lag6^2)
int_5 <- grconvertY(links[[5]]$from_y, from = "ndc", to = "user") # I(tsa_lag17^2)
int_6 <- grconvertY(links[[6]]$from_y, from = "ndc", to = "user") 
# nino_lag27:dmi_lag47
int_7 <- grconvertY(links[[7]]$from_y, from = "ndc", to = "user") # nino_lag27
int_8 <- grconvertY(links[[8]]$from_y, from = "ndc", to = "user") # dmi_lag47 (base)
int_pt1 <- (int_7 + int_8)/2
segments(SEridge2_base[10], int_7, SEridge2_base[10], int_pt1, col = "chartreuse2", lty = 3, lwd = 1.5)
segments(SEridge2_base[10], int_8, SEridge2_base[10], int_pt1, col = "plum2", lty = 3, lwd = 1.5)
...
points(SEridge2_main[8], int_1,  pch = 22, col = "grey4",
        bg =  alpha("magenta4",.95), cex = 1.5,) 
points(SEridge2_main[9], int_2,  pch = 22, col = "grey4",
        bg =  alpha("magenta4",.95), cex = 1.5,) 
points(SEridge2_base[8], int_3, pch = 24, col = "black",
       bg =  alpha("plum2",.65) , cex = 1.33)
points(SEridge2_main[10], int_4,  pch = 22, col = "grey4",
        bg =  alpha("darkorange3",.95), cex = 1.5,) 
points(SEridge2_main[11], int_5,  pch = 22, col = "grey4",
        bg =  alpha("darkorange3",.95), cex = 1.5,) 
points(SEridge2_base[9], int_6, pch = 24, col = "black",
       bg =  alpha("darkgoldenrod2",.65) , cex = 1.33)
points(SEridge2_base[10], int_pt1, pch = 24, col = "black", bg = alpha("gray", 0.65), cex = 1.33) 

#link to x 
links[[1]]$to_x <- grconvertX(SEridge2_main[8], from = "user", to = "ndc")
links[[2]]$to_x <- grconvertX(SEridge2_main[9], from = "user", to = "ndc")
links[[3]]$to_x <- grconvertX(SEridge2_base[8], from = "user", to = "ndc")
links[[4]]$to_x <- grconvertX(SEridge2_main[10], from = "user", to = "ndc")
links[[5]]$to_x <- grconvertX(SEridge2_main[11], from = "user", to = "ndc")
links[[6]]$to_x <- grconvertX(SEridge2_base[9], from = "user", to = "ndc")
links[[7]]$to_x <- grconvertX(SEridge2_base[10], from = "user", to = "ndc")
links[[8]]$to_x <- grconvertX(SEridge2_base[10], from = "user", to = "ndc")
...
# --- Draw horizontal linking lines ---
par(xpd = NA)  # allow drawing outside plot regions
colors <- c(rep("magenta4", 2), "plum2",
            rep("darkorange3", 2), "darkgoldenrod3",
            "chartreuse2", "plum2")
...
png(filename = "SE3_fits.png", width = 3000, height = 3000, res = 300)
...
SEAus3_range <- c(-SEAus3_range[2], SEAus3_range[2])
