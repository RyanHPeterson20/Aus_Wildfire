...
plot(1:208, coefs[1:208], type = "l", main = "Main Effects - Climate Mode")
plot(1:208, coefs[209:416], type = "l", main = "Main Effects - Quantile")
...
new_NE <- cbind(as.matrix(NE_2019preds[[3]][,1:208]), NE_2019preds_q90[[3]])
