...
png(filename = "seaus_coeff.png", width = 3000, height = 3000, res = 300)
layout(matrix(c(1, 2,
                3, 4,
...
newnino_range <- c(-nino_range[2], nino_range[2])

plot(SE2_ninolag, SE2_ninocoef, pch = 16, col = "green4", xlim = c(1,52), ylim = newnino_range,
     xlab = "Lag", ylab = "Coefficients")
title("Nino", adj = 0)
points(SE2_ninoind, SE2_ninocoefind, pch = 1, col = "green4", cex = 1.25)
points(SE4_ninolag, SE4_ninocoef, pch = 18, col = "red3", cex = 1.5)
...
title("DMI", adj = 0)
points(SE1_dmiind, SE1_dmicoefind, pch = 0, col = "blue2")
points(SE2_dmilag, SE2_dmicoef, pch = 16, col = "green4")
points(SE2_dmiind, SE2_dmicoefind, pch = 1, col = "green4", cex = 1.25)
points(SE3_dmilag, SE3_dmicoef, pch = 17, col = "orange3")
points(SE4_dmilag, SE4_dmicoef, pch = 18, col = "red3", cex = 1.5)
points(SE4_dmiind, SE4_dmicoefind, pch = 5, col = "red3")
...
newtsa_range <- c(tsa_range[1], -tsa_range[2])

plot(SE1_tsalag, SE1_tsacoef, pch = 15, col = "blue2", xlim = c(1,52), ylim = newtsa_range,
     xlab = "Lag", ylab = "Coefficients")
title("TSA", adj = 0)
points(SE2_tsalag, SE2_tsacoef, pch = 16, col = "green4")
points(SE3_tsalag, SE3_tsacoef, pch = 17, col = "orange3")
points(SE4_tsalag, SE4_tsacoef, pch = 18, col = "red3", cex = 1.5)
abline(h=0, lty = 2)
...
newaao_range <- c(aao_range[1], -aao_range[1])

plot(SE1_aaolag, SE1_aaocoef, pch = 15, col = "blue2", xlim = c(1,52), ylim = newaao_range,
     xlab = "Lag", ylab = "Coefficients")
title("SAM (OLR)", adj = 0)
points(SE2_aaolag, SE2_aaocoef, pch = 16, col = "green4")
points(SE3_aaolag, SE3_aaocoef, pch = 17, col = "orange3")
points(SE4_aaolag, SE4_aaocoef, pch = 18, col = "red3", cex = 1.5)
abline(h=0, lty = 2)
...
newolr_range <- c(-olr_range[1], olr_range[2])

plot(SE2_olrlag, SE2_olrcoef, pch = 16, col = "green4", xlim = c(1,52), ylim = newolr_range,
     xlab = "Lag", ylab = "Coefficients")
title("OLR", adj = 0)
points(SE4_olrlag, SE4_olrcoef, pch = 18, col = "red3", cex = 1.5)
abline(h=0, lty = 2)
#add legend here
par(xpd = NA)
legend("bottomright", inset = c(-.25, 0),
       legend = c("Group 1", "Ind - Group 1", 
                  "Group 2", "Ind - Group 2",
                  "Group 3", "Ind - Group 3",
                  "Group 4", "Ind - Group 4"),
       col = c("blue2", "blue2",
...
links[[24]] <- list(
  y_val = NE1_aaocoef[6],
  from_x = grconvertX(NE1_aaolag[6], from = "user", to = "ndc"),
  from_y = grconvertY(NE1_aaocoef[6], from = "user", to = "ndc")
)
...
links[[26]] <- list(
  y_val = NE1_olrcoef[2],
  from_x = grconvertX(NE1_olrlag[2], from = "user", to = "ndc"),
  from_y = grconvertY(NE1_olrcoef[2], from = "user", to = "ndc")
)
...
#approx locations
NE1_loc <- c(0.952, 0.448, 0.255, -0.036)
NE2_loc <- c(0.728, 0.717, 0.445, 0.505, 0.002, -0.0221, -0.02)
NE3_loc <- c(0.778, 0.485, 0.438) #NE Aus 3
NE4_loc <- c(0.754, 0.751, 0.31, 0.282, 0.016)

NE1_int <- c(0.9305, 0.601, 0.22, -0.023)
NE2_int <- c(0.43, 0.272)
NE4_int <- c(0.624, 0.8375, 0.6215, 0.62, 0.622, 0.613, 0.613, 0.613)
...
plot(NE3_quad, NE3_loc, pch = 17, col = "orange3", cex = 1.5, main = "Interactions", 
     ...
     xlab = "Coefficients",
     yaxt = "n",  ylab = "")
points(NE1_quad[1:4], NE1_loc, pch = 15, col = "blue2", cex = 1)
points(NE1_quad[5:8], NE1_int, pch = 22, bg = "blue2", col = "black", cex = 1.5)
points(NE2_quad[1:7], NE2_loc, pch = 16, col = "green4", cex = 1.5)
points(NE2_quad[8:9], NE2_int, pch = 21, bg = "green4", col = "black", cex = 1.65)
points(NE4_quad[1:5], NE4_loc, pch = 18, col = "red3", cex = 1.5)
points(NE4_quad[6:13], NE4_int, pch = 23, bg = "red3", col = "black", cex = 1.65)
abline(v=0, lty = 2)
...
segments(NE2_quad[8], 0.098, NE2_quad[8], 0.77, col = "green4", lwd = 1.5, lty = 3)
links[[12]]$to_x <- grconvertX(NE2_quad[9], from = "user", to = "ndc")
links[[14]]$to_x <- grconvertX(NE2_quad[9], from = "user", to = "ndc")
segments(NE2_quad[9], 0.098, NE2_quad[9], 0.446, col = "green4", lwd = 1.5, lty = 3)
...
segments(NE1_quad[5], 0.915, NE1_quad[5], 0.946, col = "blue2", lwd = 1.5, lty = 3)
links[[21]]$to_x <- grconvertX(NE1_quad[6], from = "user", to = "ndc")
links[[22]]$to_x <- grconvertX(NE1_quad[6], from = "user", to = "ndc")
segments(NE1_quad[6], 0.29, NE1_quad[6], 0.912, col = "blue2", lwd = 1.5, lty = 3)
links[[23]]$to_x <- grconvertX(NE1_quad[7], from = "user", to = "ndc")
links[[24]]$to_x <- grconvertX(NE1_quad[7], from = "user", to = "ndc")
segments(NE1_quad[7], 0.2, NE1_quad[7], 0.24, col = "blue2", lwd = 1.5, lty = 3)
links[[25]]$to_x <- grconvertX(NE1_quad[8], from = "user", to = "ndc")
links[[26]]$to_x <- grconvertX(NE1_quad[8], from = "user", to = "ndc")
segments(NE1_quad[8], -0.036, NE1_quad[8], -0.01, col = "blue2", lwd = 1.5, lty = 3)

#NE group 4
links[[27]]$to_x <- grconvertX(NE4_quad[1], from = "user", to = "ndc")
links[[28]]$to_x <- grconvertX(NE4_quad[2], from = "user", to = "ndc")
links[[29]]$to_x <- grconvertX(NE4_quad[3], from = "user", to = "ndc")
links[[30]]$to_x <- grconvertX(NE4_quad[4], from = "user", to = "ndc")
links[[31]]$to_x <- grconvertX(NE4_quad[5], from = "user", to = "ndc")

links[[32]]$to_x <- grconvertX(NE4_quad[6], from = "user", to = "ndc")
links[[33]]$to_x <- grconvertX(NE4_quad[6], from = "user", to = "ndc")
segments(NE4_quad[6], 0.32, NE4_quad[6], 0.928 , col = "red3", lwd = 1.5, lty = 3)
links[[34]]$to_x <- grconvertX(NE4_quad[7], from = "user", to = "ndc")
links[[35]]$to_x <- grconvertX(NE4_quad[7], from = "user", to = "ndc")
segments(NE4_quad[7], 0.747, NE4_quad[7], 0.928 , col = "red3", lwd = 1.5, lty = 3)
links[[36]]$to_x <- grconvertX(NE4_quad[8], from = "user", to = "ndc")
links[[37]]$to_x <- grconvertX(NE4_quad[8], from = "user", to = "ndc")
segments(NE4_quad[8], 0.488, NE4_quad[8], 0.755 , col = "red3", lwd = 1.5, lty = 3)
links[[38]]$to_x <- grconvertX(NE4_quad[9], from = "user", to = "ndc")
links[[39]]$to_x <- grconvertX(NE4_quad[9], from = "user", to = "ndc")
segments(NE4_quad[9], 0.49, NE4_quad[9], 0.750 , col = "red3", lwd = 1.5, lty = 3)
links[[40]]$to_x <- grconvertX(NE4_quad[10], from = "user", to = "ndc")
links[[41]]$to_x <- grconvertX(NE4_quad[10], from = "user", to = "ndc")
segments(NE4_quad[10], 0.488, NE4_quad[10], 0.756 , col = "red3", lwd = 1.5, lty = 3)
links[[42]]$to_x <- grconvertX(NE4_quad[11], from = "user", to = "ndc")
links[[43]]$to_x <- grconvertX(NE4_quad[11], from = "user", to = "ndc")
segments(NE4_quad[11], 0.488, NE4_quad[11], 0.738 , col = "red3", lwd = 1.5, lty = 3)
links[[44]]$to_x <- grconvertX(NE4_quad[12], from = "user", to = "ndc")
links[[45]]$to_x <- grconvertX(NE4_quad[12], from = "user", to = "ndc")
segments(NE4_quad[12], 0.488, NE4_quad[12], 0.738 , col = "red3", lwd = 1.5, lty = 3)
links[[46]]$to_x <- grconvertX(NE4_quad[13], from = "user", to = "ndc")
links[[47]]$to_x <- grconvertX(NE4_quad[13], from = "user", to = "ndc")
segments(NE4_quad[13], 0.488, NE4_quad[13], 0.738 , col = "red3", lwd = 1.5, lty = 3)
