...
- Need to go back to the OLR files to add in weeks 1-14 of 2020.
...
save(pred_matrix, resp_matrix, file = "data_matrix.rda")
...
lag_resp <- bounded_resp_df[which(bounded_resp_df$week == i), ]
...
NEweek_lag <- data.frame(NE_Aus_anomaly_co = lag_resp$NE_Aus_anomaly_co, nino_lag, dmi_lag, tsa_lag, aao_lag)
SEweek_lag <- data.frame(SE_Aus_anomaly_co = lag_resp$SE_Aus_anomaly_co, nino_lag, dmi_lag, tsa_lag, aao_lag)
```
