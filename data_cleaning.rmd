...
NEweek_lag <- data.frame(NE_Aus_anomaly_co = lag_resp$NE_Aus_anomaly_co, nino_lag, dmi_lag, tsa_lag, aao_lag, NEolr_lag)
SEweek_lag <- data.frame(SE_Aus_anomaly_co = lag_resp$SE_Aus_anomaly_co, nino_lag, dmi_lag, tsa_lag, aao_lag, SEolr_lag)
```
