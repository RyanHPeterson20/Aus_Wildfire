...
s.index.mam <- mam.pc$PC1 + mam.pc$PC2
m.index.mam <- mam.pc$PC1 - mam.pc$PC2

s.index.jja <- jja.pc$PC1 + jja.pc$PC2
m.index.jja <- jja.pc$PC1 - jja.pc$PC2

s.index.son <- son.pc$PC1 + son.pc$PC2
m.index.son <- son.pc$PC1 - son.pc$PC2

s.index.djf <- djf.pc$PC1 + djf.pc$PC2
m.index.djf <- djf.pc$PC1 - djf.pc$PC2
