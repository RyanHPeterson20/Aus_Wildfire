...
png(filename = "DMI_coeff.png", width = 2000, height = 1200, res = 200)
par(mar = c(5, 4, 4, 9) + 0.2, xpd = TRUE)  # Increase the right margin (fourth value) to make space for the legend
plot(1:52, NE_coefs$Group_2$dmi_coef, type = "l", xlab = "Lag", ylab = "Coefficients",
...
png(filename = "nino_coeff.png", width = 2000, height = 1200, res = 200)
par(mar = c(5, 4, 4, 9) + 0.2, xpd = TRUE)  # Increase the right margin (fourth value) to make space for the legend
plot(1:52, NE_coefs$Group_2$nino_coef, type = "l", xlab = "Lag", ylab = "Coefficients",
...
png("NEresidsd_olr.png", width = 2000, height = 1200, res = 200)
...
png("SEresidsd_olr.png", width = 2000, height = 1200, res = 200)
par(mar = c(8, 4, 4, 2) + 0.1)
...
png(filename = "NE_preds2019.png", width = 2000, height = 1200, res = 200)
par(mar = c(5, 4, 4, 9) + 0.2, xpd = TRUE) 
...
legend("topright", inset = c(-0.24, 0),
       ...
       lty = c(1,1,2,2), lwd = c(2,2,1,1), bty = "o") #, bg = "white")
dev.off()

#se Aus

png(filename = "SE_preds2019.png", width = 2000, height = 1200, res = 200)
par(mar = c(5, 4, 4, 9) + 0.2, xpd = TRUE) 
