...
godas_list <- list(nc.GODAS.1982, nc.GODAS.1983, nc.GODAS.1984, nc.GODAS.1985, nc.GODAS.1986, 
                   ...
                   nc.GODAS.2016, nc.GODAS.2017, nc.GODAS.2018, nc.GODAS.2019)


#TODO: create for 1982-2015 and 1982-2019
...
save(sst.interp.SODA, sst.OISST.new, sst.array, 
     lsm.IOD, lat.values, lon.values, times, file = "sst_base.rda")

save(sst.OISST.new2, sst.godas2, 
     file = "sst_extend.rda")
...
```{r}
eof.OISST <- sst.anom.eof(updated.sst.anom, kmode = 2)
