...
#ward.D2 with sq. euclidean dist
NEhc_test4 <- constr.hclust(NE_d22, method = "complete", chron = TRUE)
SEhc_test4 <- constr.hclust(SE_d22, method = "complete", chron = TRUE)



NEhc_test3 <- constr.hclust(NE_d2, method = "average", chron = TRUE)
SEhc_test4 <- constr.hclust(SE_d2, method = "average", chron = TRUE)
...
SEhc_agg3 <- constr.hclust(SE_d22, method = "complete", chron = TRUE)
