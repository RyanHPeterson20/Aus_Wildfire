...
dum_mat[,] <- 0
X_int <- cbind(as.matrix(SE_preds[[3]][ ,1:104]), dum_mat)
X_1 <- cbind(as.matrix(SE_preds[[3]][ ,1:104]),
...
#path -> cv -> fit
temp_path <- hierNet.path( X_1, y_1, strong = TRUE, diagonal = TRUE, nlam = 10, zz = zz_new)
print(temp_path)
```
