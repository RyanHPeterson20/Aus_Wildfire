...
```{r }
#TODO: update with in/out sample predictions and groups

plot(1:32, neresp_new,  type = "l")
lines(1:32, y_nehat, col = "magenta3")
lines(1:32, y1_nehat, col = "darkmagenta", lty = 3)
abline(h = 0, lty = 2)
abline(v = c(12.5, 17.5, 21.5), lty = 2, col = "red" )

plot(1:32, seresp_new,  type = "l")
lines(1:32, y_sehat, col = "magenta3")
lines(1:32, y1_sehat, col = "darkmagenta", lty = 3)
abline(h = 0, lty = 2)
abline(v = c(8.5, 16.5, 20.5), lty = 2, col = "red" )
```
...
main1_df <- data.frame(main_names, coef1_main)
...
interact1_df <- data.frame(interact_names[,2], interact_names[,1], coef_int )
...
plot(main_loc, coef_main, pch = 16, xlim = c(0,260))
