...
#lambda setup (expand the range here)
lambda_seq <- seq(380, 155, length.out = 24)
```
...
```{r}
NErefit2 <- refit_bic(NE2_path, max_index = 24, ebic.gamma = 0.2, gic.gamma = 2.15,
                      lambda.min = FALSE, AIC.c = FALSE,
                      intercept = FALSE,
...
#lambda setup
lambda_seq <- seq(205, 80, length.out = 24)
```
...
```{r refit}
SErefit2 <- refit_bic(SE2_path, max_index = 24, ebic.gamma = 0.25, gic.gamma = 2.15,
                      lambda.min = FALSE, AIC.c = FALSE,
                      intercept = FALSE,
...
SEcoefs2 <- get_coefs(SE2_path, max_index = 24, 
                      resp = SE_resp[[2]], preds = SE_preds_test[[2]], 
                      preds_quant = SE_preds_test[[2]])
...
TODO: pick up here tweak with the lambda range
...
lambda_seq <- seq(725, 350, length.out = 24)
...
```{r refit}
SEcoefs1 <- get_coefs(SE1path_sans, max_index = 3, 
