...
abline(h = 0, lty = 2)
points(nino_max1, NEcor_list[[1]]$nino_cor[nino_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, NEcor_list[[2]]$nino_cor)
points(nino_max2, NEcor_list[[2]]$nino_cor[nino_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, NEcor_list[[3]]$nino_cor)
points(nino_max3, NEcor_list[[3]]$nino_cor[nino_max3], pch = 19, col = "blue3", cex = 1.33)
title("Nino", adj = 0)
...
plot(1:52, NEcor_list[[1]]$dmi_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(dmi_max1, NEcor_list[[1]]$dmi_cor[dmi_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, NEcor_list[[2]]$dmi_cor)
points(dmi_max2, NEcor_list[[2]]$dmi_cor[dmi_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, NEcor_list[[3]]$dmi_cor)
points(dmi_max3, NEcor_list[[3]]$dmi_cor[dmi_max3], pch = 19, col = "blue3", cex = 1.33)
title("DMI", adj = 0)
...
plot(1:52, NEcor_list[[1]]$tsa_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag", col = "red3", lwd = 0.75)
abline(h = 0, lty = 2)
points(tsa_max1, NEcor_list[[1]]$tsa_cor[tsa_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, NEcor_list[[2]]$tsa_cor)
points(tsa_max2, NEcor_list[[2]]$tsa_cor[tsa_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, NEcor_list[[3]]$tsa_cor)
points(tsa_max3, NEcor_list[[3]]$tsa_cor[tsa_max3], pch = 19, col = "blue3", cex = 1.33)
title("TSA", adj = 0)
...
plot(1:52, NEcor_list[[1]]$aao_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(aao_max1, NEcor_list[[1]]$aao_cor[aao_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, NEcor_list[[2]]$aao_cor)
points(aao_max2, NEcor_list[[2]]$aao_cor[aao_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, NEcor_list[[3]]$tsa_cor)
points(aao_max3, NEcor_list[[3]]$aao_cor[aao_max3], pch = 19, col = "blue3", cex = 1.33)
title("SAM (AAO)", adj = 0)
...
plot(1:52, NEcor_list[[1]]$olr_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(olr_max1, NEcor_list[[1]]$olr_cor[olr_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, NEcor_list[[2]]$olr_cor)
points(olr_max2, NEcor_list[[2]]$olr_cor[olr_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, NEcor_list[[3]]$olr_cor)
points(olr_max3, NEcor_list[[3]]$olr_cor[olr_max3], pch = 19, col = "blue3", cex = 1.33)
title("OLR", adj = 0)
...
plot(1:52, SEcor_list[[1]]$nino_cor, type = "l", ylim = c(-1,1),
     ylab = "Correlation", xlab = "Lag")
abline(h = 0, lty = 2)
points(nino_max1, SEcor_list[[1]]$nino_cor[nino_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, SEcor_list[[2]]$nino_cor)
points(nino_max2, SEcor_list[[2]]$nino_cor[nino_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, SEcor_list[[3]]$nino_cor)
points(nino_max3, SEcor_list[[3]]$nino_cor[nino_max3], pch = 19, col = "blue3", cex = 1.33)
title("Nino", adj = 0)
...
plot(1:52, SEcor_list[[1]]$dmi_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(dmi_max1, SEcor_list[[1]]$dmi_cor[dmi_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, SEcor_list[[2]]$dmi_cor)
points(dmi_max2, SEcor_list[[2]]$dmi_cor[dmi_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, SEcor_list[[3]]$dmi_cor)
points(dmi_max3, SEcor_list[[3]]$dmi_cor[dmi_max3], pch = 19, col = "blue3", cex = 1.33)
title("DMI", adj = 0)
...
plot(1:52, SEcor_list[[1]]$tsa_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(tsa_max1, SEcor_list[[1]]$tsa_cor[tsa_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, SEcor_list[[2]]$tsa_cor)
points(tsa_max2, SEcor_list[[2]]$tsa_cor[tsa_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, SEcor_list[[3]]$tsa_cor)
points(tsa_max3, SEcor_list[[3]]$tsa_cor[tsa_max3], pch = 19, col = "blue3", cex = 1.33)
title("TSA", adj = 0)
...
plot(1:52, SEcor_list[[1]]$aao_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(aao_max1, SEcor_list[[1]]$aao_cor[aao_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, SEcor_list[[2]]$aao_cor)
points(aao_max2, SEcor_list[[2]]$aao_cor[aao_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, SEcor_list[[3]]$tsa_cor)
points(aao_max3, SEcor_list[[3]]$aao_cor[aao_max3], pch = 19, col = "blue3", cex = 1.33)
title("SAM (AAO)", adj = 0)
...
plot(1:52, SEcor_list[[1]]$olr_cor, type = "l", ylim = c(-1,1),
     ylab = "", xlab = "Lag")
abline(h = 0, lty = 2)
points(olr_max1, SEcor_list[[1]]$olr_cor[olr_max1], pch = 16, col = "red3", cex = 1.33)
lines(1:52, SEcor_list[[2]]$olr_cor)
points(olr_max2, SEcor_list[[2]]$olr_cor[olr_max2], pch = 17, col = "green3", cex = 1.33)
lines(1:52, SEcor_list[[3]]$olr_cor)
points(olr_max3, SEcor_list[[3]]$olr_cor[olr_max3], pch = 19, col = "blue3", cex = 1.33)
title("OLR", adj = 0)
