...
segments(NEridge2_main[32], int_pt[3], NEridge2_main[32], (int_pt[3]+int_pt[21])/2, col = "green4", lty = 3, lwd = 1)
segments(NEridge2_main[32], int_pt[21], NEridge2_main[32], (int_pt[3]+int_pt[21])/2, col = "red3", lty = 3, lwd = 1)
#nino_lag30:aao_lag40  sans
segments(NEridge2_main1[32], int_pt[4], NEridge2_main1[32], (int_pt[4]+int_pt[22])/2, col = "chartreuse2", lty = 3, lwd = 1)
segments(NEridge2_main1[32], int_pt[22], NEridge2_main1[32], (int_pt[4]+int_pt[22])/2, col = "coral2", lty = 3, lwd = 1)
#dmi_lag12:NEolr_lag1 main
segments(NEridge2_main[33], int_pt[10], NEridge2_main[33], (int_pt[10]+int_pt[29])/2, col = "magenta4", lty = 3, lwd = 1)
segments(NEridge2_main[33], int_pt[29], NEridge2_main[33], (int_pt[10]+int_pt[29])/2, col = "turquoise4", lty = 3, lwd = 1)
#dmi_lag12:NEolr_lag1 sans
segments(NEridge2_main1[33], int_pt[11], NEridge2_main1[33], (int_pt[11]+int_pt[30])/2, col = "plum2", lty = 3, lwd = 1)
segments(NEridge2_main1[33], int_pt[30], NEridge2_main1[33], (int_pt[11]+int_pt[30])/2, col = "paleturquoise3", lty = 3, lwd = 1)
#dmi_lag41:NEolr_lag1 main
segments(NEridge2_main[34], int_pt[12], NEridge2_main[34], (int_pt[12]+int_pt[31])/2, col = "magenta4", lty = 3, lwd = 1)
segments(NEridge2_main[34], int_pt[31], NEridge2_main[34], (int_pt[12]+int_pt[31])/2, col = "turquoise4", lty = 3, lwd = 1)
#dmi_lag41:NEolr_lag1 sans
segments(NEridge2_main1[34], int_pt[13], NEridge2_main1[34], (int_pt[13]+int_pt[32])/2, col = "plum2", lty = 3, lwd = 1)
segments(NEridge2_main1[34], int_pt[32], NEridge2_main1[34], (int_pt[13]+int_pt[32])/2, col = "paleturquoise3", lty = 3, lwd = 1)
#dmi_lag50:NEolr_lag2 main
segments(NEridge2_main[35], int_pt[14], NEridge2_main[35], (int_pt[14]+int_pt[33])/2, col = "magenta4", lty = 3, lwd = 1)
segments(NEridge2_main[35], int_pt[33], NEridge2_main[35], (int_pt[14]+int_pt[33])/2, col = "turquoise4", lty = 3, lwd = 1)
#dmi_lag50:NEolr_lag2 sans
segments(NEridge2_main1[35], int_pt[15], NEridge2_main1[35], (int_pt[15]+int_pt[34])/2, col = "plum2", lty = 3, lwd = 1)
segments(NEridge2_main1[35], int_pt[34], NEridge2_main1[35], (int_pt[15]+int_pt[34])/2, col = "paleturquoise3", lty = 3, lwd = 1)
#tsa_lag44:NEolr_lag52 main
segments(NEridge2_main[36], int_pt[19], NEridge2_main[36], (int_pt[19]+int_pt[35])/2, col = "darkorange3", lty = 3, lwd = 1)
segments(NEridge2_main[36], int_pt[35], NEridge2_main[36], (int_pt[19]+int_pt[35])/2, col = "turquoise4", lty = 3, lwd = 1)
...
colors <- c( rep(c("green4","chartreuse3"), 2), "plum2", rep(c("magenta4", "plum2"), 5),
...
legend("right", inset = c(-0.52, 0.05),
       title = "TSA",
       legend = c("Coef w/ 2019/2020", "Coef w/o 2019/2020", "Variable w/o 2019/2020"),
       pch = c(22, 22, 24),
       col = c("grey4", "black", "grey4"),
