...
1. Get SST anomalies for each data product
  ...
  c. Seasonal Average
    i. SON (Sept, Oct, Nov)
-> 2. Alternative SST Anomalies (from previous work that has been very close in the past)
    a. 
3. Multi-Product Average
...
#mean 
mean.range <- range(godas.mean, oras.mean, oisst.mean, soda.mean, na.rm = TRUE)
breaks.mean <- seq(mean.range[1], mean.range[2], length.out = length(cols.ryb12)+1)
